...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	   ...
	   const NotSafe = (reaction, user) => reaction.emoji.name === '🔞' && user.id === message.author.id;
	   const NSFW = msg.createReactionCollector(NotSafe, {time: 360000})

	   const Giveaway = (reaction, user) => reaction.emoji.name === '🎉' && user.id === message.author.id;
	   const Sorte = msg.createReactionCollector(Giveaway, {time: 360000})

	   const Seta = (reaction, user) => reaction.emoji.name === '⬅️' && user.id === message.author.id;
