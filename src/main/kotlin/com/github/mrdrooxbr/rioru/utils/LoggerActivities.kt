...
class LoggerActivities {
    companion object {
        fun info(content: String) = println(format("\u001B[33m", content))
        fun success(content: String) = println(format("\u001B[32m", content))
        fun error(content: String) = println(format("\u001B[31m", content))
